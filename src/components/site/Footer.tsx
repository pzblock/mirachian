  ...
  return (
    <footer className="border-t border-line">
      <div className="mx-auto flex max-w-6xl flex-col gap-12 px-5 py-20 md:flex-row md:items-end md:justify-between md:px-8">
        <div>
          <p className="font-display text-xl tracking-[0.28em] text-fg uppercase">
            <Mirachian />
          </p>
        ...
        <div className="flex flex-col gap-4 text-[0.7rem] tracking-[0.14em] text-muted uppercase">
          <a href={`mailto:${CONTACT_EMAIL}`} className="nav-link hover:text-pearl">
            {CONTACT_EMAIL}
          </a>
          <nav className="flex flex-wrap gap-6">
            <a href="#voyage" className="nav-link hover:text-pearl">
              Voyage
            </a>
            <a href="#passages" className="nav-link hover:text-pearl">
              Passages
            </a>
            <a href="#descend" className="nav-link hover:text-pearl">
              Depth
            </a>
            <a href="#ledger" className="nav-link hover:text-pearl">
              Ledger
            </a>
            <a href="#craft" className="nav-link hover:text-pearl">
              Craft
            </a>
            <a href="#reserve" className="nav-link hover:text-pearl">
              Reserve
            </a>
          </nav>
        </div>
      ...
      <div className="legal-copy mx-auto max-w-6xl border-t border-line px-5 py-8 md:px-8">
        <p>
          © <Mirachian /> Undersea. Private expeditions from Key West. Limited
          capacity.
        </p>
